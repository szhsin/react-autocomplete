"use strict";
//#region src/features/atom/autoInline.ts
const autoInline = ({ onRequestItem }) => ({ getItemValue, setTmpValue, setFocusIndex }) => ({ getInputProps: () => ({
