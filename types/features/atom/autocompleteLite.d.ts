...
declare const autocompleteLite: <T>({ rovingText, constricted, selectOnBlur, deselectOnClear, deselectOnChange }?: AutocompleteFeatureProps<T>) => AutocompleteLiteFeature<T>;
