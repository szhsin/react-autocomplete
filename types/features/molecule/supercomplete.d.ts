...
declare const supercomplete: <T>({ getInlineItem, ...rest }: Pick<FeatureProps<T>, "getInlineItem" | "constricted" | "selectOnBlur" | "deselectOnClear" | "deselectOnChange">) => SupercompleteFeature<T>;
