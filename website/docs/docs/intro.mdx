...
- **Lightweight**: At just <BundleLink/>[^2], you get a fully functional and accessible autocomplete solution in React. It's almost negligible in size and likely lighter than creating one from scratch, so you can adopt it without hesitation.
...
Here’s a live example of the <BundleLink/> accessible React autocomplete:
